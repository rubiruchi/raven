...
class FrameworkTest(object):
  #@pytest.fixture
  def runRavenTest(self,fname,tests,testDir,relErr=1e-10):
    """
    ...
    """
    self.__rel_err = relErr # TODO is this threadsafe?
  ...
  #      CSV      #
  #################
  def _checkCSV(self,testFile,goldFile):
