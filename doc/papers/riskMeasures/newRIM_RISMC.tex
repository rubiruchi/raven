...
\begin{figure}
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \centerline{\includegraphics[scale=0.3]{pdf0.png}}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \centerline{\includegraphics[scale=0.3]{margin0.png}}
  \end{subfigure}
...
Assume two pdfs are given: $pdf_1(x)$ and $pdf_2(x)$. A couple of approaches can be followed: Z-test or 
