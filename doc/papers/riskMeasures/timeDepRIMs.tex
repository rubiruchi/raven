...
\begin{figure}
    \centering
    \centerline{\includegraphics[scale=0.3]{1-plotStatus_line-line.pdf}}
...
\begin{figure}
  ...
  \begin{subfigure}{.5\textwidth}
    \centering
    \centerline{\includegraphics[scale=0.3]{1-plotR0_line.pdf}}
  \end{subfigure}%
  \begin{subfigure}{.5\textwidth}
    \centering
    \centerline{\includegraphics[scale=0.3]{1-plotFV_line-line-line.pdf}}
  \end{subfigure}
