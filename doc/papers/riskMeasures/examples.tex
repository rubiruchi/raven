...
\begin{figure}
    \centering
    \includegraphics[scale=0.3]{2D.pdf}
    \caption{}
    \label{fig:2Danalogy}
\end{figure} 
...
\begin{figure}
    \centering
    \centerline{\includegraphics[scale=0.4]{case1_FT.pdf}}
...
\begin{figure}
    \centering
    \centerline{\includegraphics[scale=0.4]{limitTime.pdf}}
    \caption{}
    \label{fig:limitTime}
\end{figure}
...
\begin{figure}
    \centering
    \centerline{\includegraphics[scale=0.4]{adaptiveSampling.pdf}}
